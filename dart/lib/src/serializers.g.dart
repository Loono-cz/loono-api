...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(AccountOnboarding.serializer)
      ..add(AccountUpdate.serializer)
      ..add(Badge.serializer)
      ..add(BadgeType.serializer)
      ..add(ConsultancyFormContent.serializer)
      ..add(Error.serializer)
      ..add(ExaminationActionType.serializer)
      ..add(ExaminationCategoryType.serializer)
      ...
      ..add(HealthcareCategoryType.serializer)
      ...
      ..add(SelfExaminationFindingResponse.serializer)
      ..add(SelfExaminationPreventionStatus.serializer)
      ..add(SelfExaminationResult.serializer)
      ..add(SelfExaminationResultResultEnum.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ExaminationRecord)]),
          () => new ListBuilder<ExaminationRecord>())
      ..addBuilderFactory(
          const FullType(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(HealthcareProviderId)]),
          () => new ListBuilder<HealthcareProviderId>())
      ..addBuilderFactory(
