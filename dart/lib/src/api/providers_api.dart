...
class ProvidersApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [HealthcareProviderLastUpdate] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<HealthcareProviderLastUpdate>> getProvidersLastupdate({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/providers/lastupdate';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    HealthcareProviderLastUpdate _responseData;

    try {
      const _responseType = FullType(HealthcareProviderLastUpdate);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as HealthcareProviderLastUpdate;
    ...
    return Response<HealthcareProviderLastUpdate>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateStatusMessage] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateStatusMessage>> getProvidersUpdate({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/providers/update';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    UpdateStatusMessage _responseData;

    try {
      const _responseType = FullType(UpdateStatusMessage);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UpdateStatusMessage;
    ...
    return Response<UpdateStatusMessage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [healthcareProviderIdList] - Healthcare provider IDs
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<HealthcareProviderDetailList>> postProvidersDetail({ 
    ...
    final _path = r'/providers/details';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(HealthcareProviderIdList);
      _bodyData = healthcareProviderIdList == null ? null : _serializers.serialize(healthcareProviderIdList, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [UpdateStatusMessage] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateStatusMessage>> updateCorrectedProvidersFunc({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
