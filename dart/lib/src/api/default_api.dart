...
class DefaultApi {
  ...
  Future<Response<void>> feedback({ 
    ...
    try {
      const _type = FullType(UserFeedback);
      _bodyData = userFeedback == null ? null : _serializers.serialize(userFeedback, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> postConsultancyFrom({ 
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> updateCorrectedProvidersFunc({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
