...
abstract class ExaminationPreventionStatus implements Built<ExaminationPreventionStatus, ExaminationPreventionStatusBuilder> {
    ...
    // enum examinationTypeEnum {  COLONOSCOPY,  DERMATOLOGIST,  MAMMOGRAM,  OPHTHALMOLOGIST,  ULTRASOUND_BREAST,  UROLOGIST,  DENTIST,  GENERAL_PRACTITIONER,  PHYSIOTHERAPY,  PEDIATRICIAN,  GYNECOLOGIST,  INTERN,  SURGERY,  ORTHOPEDICS,  REHABILITATION,  PSYCHIATRY,  NEUROLOGY,  PSYCHOLOGY,  ENDOCRINOLOGY_AND_HORMONES,  DENTAL_HYGIENE,  CARDIOLOGY,  ORL,  SPEECH_THERAPIST,  ALLERGOLOGY,  IMMUNOLOGY,  ORTHODONTICS,  PULMONARY,  HEMATOLOGY,  GASTROENTEROLOGY,  RHEUMATOLOGY,  PALLIATIVE_MEDICINE,  NEPHROLOGY,  VASCULAR,  ERGOTHERAPY,  ONCOLOGY,  NUTRITION,  PHONIATRICS,  GENETICS,  SPORTS_MEDICINE,  SEXOLOGY,  REPRODUCTIVE_MEDICINE,  OTHER,  };
