...
class _$Badge extends Badge {
  ...
  _$Badge._({required this.type, required this.level}) : super._() {
  ...
  bool operator ==(Object other) {
    ...
    return other is Badge && type == other.type && level == other.level;
  }

  @override
  int get hashCode {
    return $jf($jc($jc(0, type.hashCode), level.hashCode));
  }
